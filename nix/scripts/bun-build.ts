import solidPlugin from "./packages/strukcode/node_modules/@opentui/solid/scripts/solid-plugin"
import path from "path"
import fs from "fs"

const version = "@VERSION@"
const pkg = path.join(process.cwd(), "packages/strukcode")
...
const manifestName = "strukcode-assets.manifest"
...
const result = await Bun.build({
  ...
  compile: {
    ...
    execArgv: ["--user-agent=strukcode/" + version, "--use-system-ca", "--"],
    windows: {},
  },
})
...
const dest = path.join(pkg, "strukcode-worker.js")
