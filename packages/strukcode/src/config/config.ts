...
export namespace Config {
  ...
  export const state = Instance.state(async () => {
    ...
    if (Flag.STRUKCODE_CONFIG) {
      result = mergeConfigWithPlugins(result, await loadFile(Flag.STRUKCODE_CONFIG))
    ...
    if (Flag.STRUKCODE_CONFIG_CONTENT) {
      result = mergeConfigWithPlugins(result, JSON.parse(Flag.STRUKCODE_CONFIG_CONTENT))
