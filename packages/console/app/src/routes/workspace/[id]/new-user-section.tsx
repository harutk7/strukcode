...
import { Key } from "@strukcode-ai/console-core/key.js"
    ...
    <Show when={isNew()}>
      <div class={styles.root}>
        <div data-component="feature-grid">
          ...
          <div data-slot="feature">
            <h3>No Lock-in</h3>
            <p>Use Zen with any coding agent, and continue using other providers with strukcode whenever you want.</p>
          </div>
        </div>
        ...
        <div data-component="next-steps">
          <ol>
            ...
            <li>
              Run <code>strukcode auth login</code> and select strukcode
            </li>
            <li>Paste your API key</li>
            <li>
              Start strukcode and run <code>/models</code> to select a model
            </li>
          </ol>
        </div>
      </div>
