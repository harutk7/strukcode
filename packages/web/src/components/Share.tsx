...
import { IconStrukcode } from "./icons/custom"
import styles from "./share.module.css"
import type { MessageV2 } from "strukcode/session/message-v2"
import type { Message } from "strukcode/session/message"
import type { Session } from "strukcode/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="strukcode version" data-slot="item">
                <div data-slot="icon" title="strukcode">
                  <IconStrukcode width={16} height={16} />
                </div>
