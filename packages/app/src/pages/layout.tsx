...
import { base64Decode, base64Encode } from "@strukcode-ai/util/encode"
import { Avatar } from "@strukcode-ai/ui/avatar"
import { ResizeHandle } from "@strukcode-ai/ui/resize-handle"
import { Button } from "@strukcode-ai/ui/button"
import { Icon } from "@strukcode-ai/ui/icon"
import { IconButton } from "@strukcode-ai/ui/icon-button"
import { Tooltip, TooltipKeybind } from "@strukcode-ai/ui/tooltip"
import { Collapsible } from "@strukcode-ai/ui/collapsible"
import { DiffChanges } from "@strukcode-ai/ui/diff-changes"
import { Spinner } from "@strukcode-ai/ui/spinner"
import { Mark } from "@strukcode-ai/ui/logo"
import { getFilename } from "@strukcode-ai/util/path"
import { DropdownMenu } from "@strukcode-ai/ui/dropdown-menu"
import { Session } from "@strukcode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@strukcode-ai/ui/toast"
import { useGlobalSDK } from "@/context/global-sdk"
import { useNotification } from "@/context/notification"
import { usePermission } from "@/context/permission"
import { Binary } from "@strukcode-ai/util/binary"

import { useDialog } from "@strukcode-ai/ui/context/dialog"
import { useTheme, type ColorScheme } from "@strukcode-ai/ui/theme"
...
export default function Layout(props: ParentProps) {
    ...
    async function pollUpdate() {
      ...
      if (updateAvailable && toastId === undefined) {
        toastId = showToast({
          ...
          description: `A new version of StrukCode (${version}) is now available to install.`,
          actions: [
            {
  ...
  const ProjectAvatar = (props: {
    ...
    const strukcode = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"

    return (
      <div class="relative size-5 shrink-0 rounded-sm">
        <Avatar
          fallback={name()}
          src={props.project.id === strukcode ? "https://strukcode.ai/favicon.svg" : props.project.icon?.url}
      ...
      <div class="flex flex-col self-stretch h-full items-center justify-between overflow-hidden min-h-0">
        ...
        <div class="flex flex-col gap-1.5 self-stretch items-start shrink-0 px-2 py-3">
            ...
            <Match when={providers.all().length > 0 && !providers.paid().length && expanded()}>
              <div class="rounded-md bg-background-stronger shadow-xs-border-base">
                <div class="p-3 flex flex-col gap-2">
                  ...
                  <div class="text-text-base">StrukCode includes free models so you can start immediately.</div>
          ...
          <Tooltip placement="right" value="Share feedback" inactive={expanded()}>
            <Button
              as={"a"}
              href="https://strukcode.ai/desktop-feedback"
              target="_blank"
              class="flex w-full text-left justify-start text-text-base stroke-[1.5px] rounded-lg px-2"
              variant="ghost"
              size="large"
