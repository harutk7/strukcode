import { useFilteredList } from "@strukcode-ai/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { FileIcon } from "@strukcode-ai/ui/file-icon"
...
import { Select } from "@strukcode-ai/ui/select"
import { getDirectory, getFilename } from "@strukcode-ai/util/path"
...
import { createStrukcodeClient, type Message, type Part } from "@strukcode-ai/sdk/v2/client"
import { Binary } from "@strukcode-ai/util/binary"
import { showToast } from "@strukcode-ai/ui/toast"
import { base64Encode } from "@strukcode-ai/util/encode"
