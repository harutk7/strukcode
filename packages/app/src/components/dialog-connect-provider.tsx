import type { ProviderAuthAuthorization } from "@strukcode-ai/sdk/v2/client"
import { Button } from "@strukcode-ai/ui/button"
import { useDialog } from "@strukcode-ai/ui/context/dialog"
import { Dialog } from "@strukcode-ai/ui/dialog"
...
import { List, type ListRef } from "@strukcode-ai/ui/list"
import { ProviderIcon } from "@strukcode-ai/ui/provider-icon"
import { Spinner } from "@strukcode-ai/ui/spinner"
import { TextField } from "@strukcode-ai/ui/text-field"
import { showToast } from "@strukcode-ai/ui/toast"
              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "strukcode"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            StrukCode Zen gives you access to a curated set of reliable optimized models for coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                          ...
                          <div class="text-14-regular text-text-base">
                            Visit{" "}
                            <Link href="https://strukcode.ai/zen" tabIndex={-1}>
                              strukcode.ai/zen
                            </Link>{" "}
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in StrukCode.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in StrukCode.
                        </div>
