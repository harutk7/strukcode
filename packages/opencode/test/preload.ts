...
const dir = path.join(os.tmpdir(), "strukcode-test-data-" + process.pid)
...
process.env["STRUKCODE_TEST_HOME"] = testHome
...
const cacheDir = path.join(dir, "cache", "strukcode")
...
process.env["STRUKCODE_DISABLE_MODELS_FETCH"] = "true"
