...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/strukcode.git")).toEqual({ owner: "sst", repo: "strukcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/strukcode")).toEqual({ owner: "sst", repo: "strukcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/strukcode.git")).toEqual({ owner: "sst", repo: "strukcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/strukcode")).toEqual({ owner: "sst", repo: "strukcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/strukcode.git")).toEqual({ owner: "sst", repo: "strukcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/strukcode")).toEqual({ owner: "sst", repo: "strukcode" })
})
