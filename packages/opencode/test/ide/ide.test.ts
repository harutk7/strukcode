...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders STRUKCODE_CALLER", () => {
    process.env["STRUKCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode STRUKCODE_CALLER", () => {
    process.env["STRUKCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown STRUKCODE_CALLER", () => {
    process.env["STRUKCODE_CALLER"] = "unknown"
