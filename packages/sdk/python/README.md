...
This package provides a Python SDK for the Strukcode API. It is generated using openapi-python-client (not Stainless).
...
- PyPI: https://img.shields.io/pypi/v/strukcode-ai?style=flat-square
...
3. Copy the generated Python package into src/strukcode_ai
...
client = StrukCodeClient(retries=2, backoff_factor=0.1)
...
- The generator targets OpenAPI 3.1 emitted by the strukcode server at /doc.
