...
/**
 * Server configuration for strukcode serve and web commands
 */
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://strukcode.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://strukcode.ai/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
