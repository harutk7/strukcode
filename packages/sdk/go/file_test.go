...
func TestFileListWithOptionalParams(t *testing.T) {
	...
	_, err := client.File.List(context.TODO(), strukcode.FileListParams{
		Path:      strukcode.F("path"),
...
func TestFileReadWithOptionalParams(t *testing.T) {
	...
	_, err := client.File.Read(context.TODO(), strukcode.FileReadParams{
		Path:      strukcode.F("path"),
		Directory: strukcode.F("directory"),
	})
	if err != nil {
...
func TestFileStatusWithOptionalParams(t *testing.T) {
	...
	_, err := client.File.Status(context.TODO(), strukcode.FileStatusParams{
		Directory: strukcode.F("directory"),
	})
	if err != nil {
		var apierr *strukcode.Error
