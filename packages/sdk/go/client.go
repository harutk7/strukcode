...
import (
	...
	"github.com/harutk7/strukcode-sdk-go/internal/requestconfig"
	"github.com/harutk7/strukcode-sdk-go/option"
)

// Client creates a struct with services and top level methods that help with
// interacting with the strukcode API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (STRUKCODE_BASE_URL). This should
// be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("STRUKCODE_BASE_URL"); ok {
...
// environment (STRUKCODE_BASE_URL). The option passed in as arguments are applied
