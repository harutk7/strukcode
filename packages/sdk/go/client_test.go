...
import (
	...
	"github.com/harutk7/strukcode-sdk-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Session.List(context.Background(), strukcode.SessionListParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Session.List(context.Background(), strukcode.SessionListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Session.List(cancelCtx, strukcode.SessionListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Session.List(deadlineCtx, strukcode.SessionListParams{})
		if err == nil {
...
func TestContextDeadlineStreaming(t *testing.T) {
	...
	go func() {
		...
		stream := client.Event.ListStreaming(deadlineCtx, strukcode.EventListParams{})
		for stream.Next() {
			_ = stream.Current()
		}
		if stream.Err() == nil {
