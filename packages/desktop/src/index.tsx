...
import { AppBaseProviders, AppInterface, PlatformProvider, Platform } from "@strukcode-ai/app"
    ...
    await Promise.resolve()
      .then(() => {
        const notification = new Notification(title, {
          body: description ?? "",
          icon: "https://strukcode.ai/favicon-96x96.png",
        })
...
function ServerGate(props: ParentProps) {
  const [status] = createResource(async () => {
    if (window.__STRUKCODE__?.serverReady) return
