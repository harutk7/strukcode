...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/harutk7/strukcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for harutk7/strukcode...\n")
...
console.log("Fetching npm all-time downloads for strukcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("strukcode-ai")
